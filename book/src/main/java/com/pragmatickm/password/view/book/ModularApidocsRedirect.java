 ...
 */
package com.pragmatickm.password.view.book;
...
@WebServlet("/password/view/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/password/view/apidocs/com.pragmatickm.password.view/com" + Objects.toString(req.getPathInfo(), ""),
